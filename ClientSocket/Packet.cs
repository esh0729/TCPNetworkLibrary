...
{
	/// <summary>
	/// 소켓 통신에서 데이터의 전송 및 수신에 사용될 데이터 저장
	/// </summary>
	public class Packet
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			// 헤더사이즈가 등록된 다음의 데이터에 1바이트 형식으로 패킷타입이 전송됨
		...
		{
			short value = BitConverter.ToInt16(m_buffer, m_nPosition);
			m_nPosition += sizeof(short);
		...
		public int PopInt32()
		{
			int value = BitConverter.ToInt32(m_buffer, m_nPosition);
			m_nPosition += sizeof(int);
		...
		{
			float value = BitConverter.ToSingle(m_buffer, m_nPosition);
		...
		/// <summary>
		/// 패킷을 데이터 전송이 가능한 ArraySegment 형태로 변환하는 함수
		/// </summary>
